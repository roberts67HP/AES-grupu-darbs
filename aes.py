...
class AES :
    ...
    def generate_key (self, size) :
        ...
        tempKey = chr(0x00)+chr(0x01)+chr(0x02)+chr(0x03)+chr(0x04)+chr(0x05)+chr(0x06)+chr(0x07)+chr(0x08)+chr(0x09)+chr(0x0a)+chr(0x0b)+chr(0x0c)+chr(0x0d)+chr(0x0e)+chr(0x0f)
